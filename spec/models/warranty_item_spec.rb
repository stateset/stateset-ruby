...
# Unit tests for OpenapiClient::WarrantyItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WarrantyItem do
  let(:instance) { OpenapiClient::WarrantyItem.new }

  describe 'test an instance of WarrantyItem' do
    it 'should create an instance of WarrantyItem' do
      expect(instance).to be_instance_of(OpenapiClient::WarrantyItem)
    end
  end
