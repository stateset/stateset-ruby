...
# Unit tests for OpenapiClient::Customers
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Customers do
  let(:instance) { OpenapiClient::Customers.new }

  describe 'test an instance of Customers' do
    it 'should create an instance of Customers' do
      expect(instance).to be_instance_of(OpenapiClient::Customers)
    end
  end
