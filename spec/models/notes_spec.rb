...
# Unit tests for OpenapiClient::Notes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Notes do
  let(:instance) { OpenapiClient::Notes.new }

  describe 'test an instance of Notes' do
    it 'should create an instance of Notes' do
      expect(instance).to be_instance_of(OpenapiClient::Notes)
    end
  end
