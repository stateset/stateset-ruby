...
# Unit tests for OpenapiClient::Warranty
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Warranty do
  let(:instance) { OpenapiClient::Warranty.new }

  describe 'test an instance of Warranty' do
    it 'should create an instance of Warranty' do
      expect(instance).to be_instance_of(OpenapiClient::Warranty)
    end
  end
  ...
  describe 'test attribute "warranty_number"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "warranty_name"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "warranty_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
