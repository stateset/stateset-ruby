...
# Unit tests for OpenapiClient::WorkOrder
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WorkOrder do
  let(:instance) { OpenapiClient::WorkOrder.new }

  describe 'test an instance of WorkOrder' do
    it 'should create an instance of WorkOrder' do
      expect(instance).to be_instance_of(OpenapiClient::WorkOrder)
    end
  end
  ...
  describe 'test attribute "work_order_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "manufacture_order"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
