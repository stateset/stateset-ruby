...
# Unit tests for OpenapiClient::BillOfMaterials
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BillOfMaterials do
  let(:instance) { OpenapiClient::BillOfMaterials.new }

  describe 'test an instance of BillOfMaterials' do
    it 'should create an instance of BillOfMaterials' do
      expect(instance).to be_instance_of(OpenapiClient::BillOfMaterials)
    end
  end
