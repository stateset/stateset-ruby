...
describe 'CustomersApi' do
  ...
  # @param id The id of the customers that needs to be deleted
  ...
  # @param offset Offset to return customers
  # @param order_direction Direction to return customers
  # @param [Hash] opts the optional parameters
  # @return [Customers]
  ...
  # @param customers Updated customers object
  # @param [Hash] opts the optional parameters
  # @return [nil]
