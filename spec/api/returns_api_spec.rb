...
describe 'ReturnsApi' do
  ...
  # @param model_return Created return object
  ...
  # unit tests for delete_return
  # Delete return
  # This can only be done by the logged in return.
  # @param id The id of the return that needs to be deleted
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_return test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_return_by_id
  # Get return by id
  # Get return by id with all details and items
  # @param id The id that needs to be fetched
  # @param [Hash] opts the optional parameters
  # @return [ModelReturn]
  describe 'get_return_by_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param model_return Updated reuturn object
  # @param [Hash] opts the optional parameters
  # @return [nil]
