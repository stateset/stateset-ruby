...
# Unit tests for OpenapiClient::InventoryItemsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InventoryItemsApi' do
  before do
  ...
  describe 'test an instance of InventoryItemsApi' do
    it 'should create an instance of InventoryItemsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::InventoryItemsApi)
    end
  end

  # unit tests for create_inventory_items
  # Create a new inventory items
  # Create a new inventory items. This can only be done by the logged in. 
  # @param inventory_items Created inventory items object
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'create_inventory_items test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_inventory_item_by_id
  # Get inventory items by id
  # Some description of the operation. You can use &#x60;Markdown&#x60; here. 
  # @param id The id that needs to be fetched
  # @param [Hash] opts the optional parameters
  # @return [InventoryItems]
  describe 'get_inventory_item_by_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_inventory_items
  # Get inventory items
  # Some description of the operation. You can use &#x60;Markdown&#x60; here. 
  ...
  # @param [Hash] opts the optional parameters
  # @return [InventoryItems]
  describe 'get_inventory_items test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for update_inventory_item
  # Updated inventory items
  # This can only be done by the logged in user.
  # @param id The id that needs to be updated
  # @param inventory_items Updated inventory items object
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'update_inventory_item test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
