...
# Unit tests for OpenapiClient::WorkOrderLineItemsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WorkOrderLineItemsApi' do
  before do
  ...
  describe 'test an instance of WorkOrderLineItemsApi' do
    it 'should create an instance of WorkOrderLineItemsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::WorkOrderLineItemsApi)
    end
  end

  # unit tests for get_work_item_by_id
  # Get work order item by id
  # Some description of the operation. You can use &#x60;Markdown&#x60; here. 
  # @param limit The number of items
  # @param offset Filter users without email
  # @param order_direction diretions to return work order items
  # @param [Hash] opts the optional parameters
  # @return [WorkOrderLineItems]
  describe 'get_work_item_by_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_work_line_item_by_id
  # Get work line item by id
  # Some description of the operation. You can use &#x60;Markdown&#x60; here. 
  # @param id The id that needs to be fetched
  # @param [Hash] opts the optional parameters
  # @return [WorkOrderLineItems]
  describe 'get_work_line_item_by_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for update_work_line_item
  # Updated work line item
  # This can only be done by the logged in user.
  # @param id The id that needs to be updated
  # @param work_order_line_items Updated reuturn object
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'update_work_line_item test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
