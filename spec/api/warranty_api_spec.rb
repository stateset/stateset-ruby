...
# Unit tests for OpenapiClient::WarrantyApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WarrantyApi' do
  before do
  ...
  describe 'test an instance of WarrantyApi' do
    it 'should create an instance of WarrantyApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::WarrantyApi)
    end
  end

  # unit tests for delete_warranty
  # Delete warranty
  # This can only be done by the logged in warranty.
  # @param id The id of the warranty that needs to be deleted
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_warranty test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_warranty_by_id
  # Get warranty by id
  # Some description of the operation. You can use &#x60;Markdown&#x60; here. 
  # @param id The id that needs to be fetched
  # @param [Hash] opts the optional parameters
  # @return [Warranty]
  describe 'get_warranty_by_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for update_warranty
  # Updated warranty
  # This can only be done by the logged in user.
  # @param id The id that needs to be updated
  # @param warranty Updated reuturn object
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'update_warranty test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
