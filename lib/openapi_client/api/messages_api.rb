...
module OpenapiClient
  class MessagesApi
    ...
    # @param messages [Messages] Created message object
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def create_message(messages, opts = {})
      create_message_with_http_info(messages, opts)
      nil
    end
    ...
    def create_message_with_http_info(messages, opts = {})
      ...
      if @api_client.config.client_side_validation && messages.nil?
        fail ArgumentError, "Missing the required parameter 'messages' when calling MessagesApi.create_message"
      end
      # resource path
    ...
    # @param id [String] The id of the message that needs to be deleted
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_message(id, opts = {})
      delete_message_with_http_info(id, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_message_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MessagesApi.delete_message ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling MessagesApi.delete_message"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @return [Messages]
    def get_message_by_id(id, opts = {})
      data, _status_code, _headers = get_message_by_id_with_http_info(id, opts)
      data
    end
    ...
    def get_message_by_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
      ...
      new_options = opts.merge(
        :operation => :"MessagesApi.get_message_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param [Hash] opts the optional parameters
    # @return [Messages]
    def get_messages(limit, offset, order_direction, opts = {})
      data, _status_code, _headers = get_messages_with_http_info(limit, offset, order_direction, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Messages, Integer, Hash)>] Messages data, response status code and response headers
    def get_messages_with_http_info(limit, offset, order_direction, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MessagesApi.get_messages ...'
      end
      # verify the required parameter 'limit' is set
      if @api_client.config.client_side_validation && limit.nil?
        fail ArgumentError, "Missing the required parameter 'limit' when calling MessagesApi.get_messages"
      end
      # verify the required parameter 'offset' is set
      if @api_client.config.client_side_validation && offset.nil?
        fail ArgumentError, "Missing the required parameter 'offset' when calling MessagesApi.get_messages"
      end
      # verify the required parameter 'order_direction' is set
      if @api_client.config.client_side_validation && order_direction.nil?
        fail ArgumentError, "Missing the required parameter 'order_direction' when calling MessagesApi.get_messages"
      end
      # resource path
      local_var_path = '/messages'
    ...
    # @param messages [Messages] Updated message object
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_message(id, messages, opts = {})
      update_message_with_http_info(id, messages, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_message_with_http_info(id, messages, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MessagesApi.update_message ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling MessagesApi.update_message"
      end
      # verify the required parameter 'messages' is set
      if @api_client.config.client_side_validation && messages.nil?
        fail ArgumentError, "Missing the required parameter 'messages' when calling MessagesApi.update_message"
      end
      # resource path
      local_var_path = '/messages/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
