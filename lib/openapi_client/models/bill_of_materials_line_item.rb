...
module OpenapiClient
  class BillOfMaterialsLineItem
    ...
    attr_accessor :purchase_supply_type
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::BillOfMaterialsLineItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::BillOfMaterialsLineItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'purchase_supply_type')
        self.purchase_supply_type = attributes[:'purchase_supply_type']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          quantity == o.quantity &&
          purchase_supply_type == o.purchase_supply_type &&
    ...
    def hash
      [id, part_number, part_name, quantity, purchase_supply_type, line_type, bill_of_materials_number, status].hash
    end
